        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                <a href="{{ route('campaign.index') }}"
                    class="btn bg-gray-200 dark:bg-gray-700/60 hover:bg-gray-300 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300">
                    Kembali
                </a>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <x-input type="text" name="title" id="title" class="w-full"
                        ...
                        <div>
                            ...
                            <div class="mt-2 mb-2">
                                <img src="{{ $campaign->image }}" class="w-20 h-20 object-cover rounded-md">
                            </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <x-input type="number" name="target_donation" id="target_donation" class="w-full"
                                value="{{ old('target_donation', $campaign->target_donation) }}" required />
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input class="datepicker form-input pl-9 dark:bg-gray-800 w-full" type="text"
                                    name="max_date" id="max_date" value="{{ old('max_date', $campaign->max_date) }}"
                                    required>
