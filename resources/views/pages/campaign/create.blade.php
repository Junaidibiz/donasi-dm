                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <x-input type="text" name="title" id="title" class="w-full"
                                value="{{ old('title') }}" required placeholder="Judul Campaign" />
                            @error('title')
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <x-input type="number" name="target_donation" id="target_donation" class="w-full"
                                value="{{ old('target_donation') }}" required placeholder="Contoh: 10000000" />
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input class="datepicker form-input pl-9 dark:bg-gray-800 w-full" type="text"
                                    name="max_date" id="max_date" value="{{ old('max_date') }}" required
