    ...
    <div id="sidebar"
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block" href="{{ route('dashboard') }}">
                <img class="pt-1" width="70" src="{{ asset('images/logo_damu1.png') }}"
                    alt="Logo Daarul Multazam">
            </a>
            <a class="block" href="{{ route('dashboard') }}">
                <span class="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden" aria-hidden="true"></span>
                <p class="lg:hidden lg:sidebar-expanded:block 2xl:block"><b class="block dark:text-gray-100">DONASI
                        <span class="text-damu-500 text-xs/1.5">Online</span></b><span
                        class=" dark:text-gray-300 text-xs/1.5 block"><b><i>Daarul Multazam</i></b></span></p>
            </a>
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <x-menu.item :route="route('category.index')" label="Kategori" segment="category">
                    ...
                    <x-menu.item :route="route('campaign.index')" label="Campaign" segment="campaign">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <x-menu.item :route="route('expense-reports.index')" label="Laporan Pengeluaran" segment="expense-reports">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <x-menu.item :route="route('donation.index')" label="Donation" segment="donation">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <x-menu.item :route="route('donatur.index')" label="Donatur" segment="donatur">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <x-menu.item :route="route('slider.index')" label="Slider" segment="slider">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <x-menu.item :route="route('prayers.index')" label="Kelola Doa" segment="prayers">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M7.5 8.25h9m-9 3H12m-6.75 3h9m-9 3h9M3.375 21c-.621 0-1.125-.504-1.125-1.125V4.125c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v15.75c0 .621-.504 1.125-1.125 1.125H3.375Z" />
                        </svg>
                    </x-menu.item>
